@section('scripts')
    ...
    <script>
        $(function () {
            ...
            var abicab = '<?php echo $fornitore->AbiCab == null ? '' : $fornitore->AbiCab; ?>';
            if (abicab != '' && abicab != null)
            {
                var descrabicab = '<?php echo $fornitore->AbiCab == null ? '' : DB::table("abicab")->where("Codice", $fornitore->AbiCab)->first()->Descrizione; ?>';
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        @if ($formmethod == 'create')
                            {!! Form::text('Codice', $fornitore->Codice, ['class' => 'form-control', 'readonly']) !!}
                        @endif
                    </div>
                </div>
                <div class="col-lg-10">
        ...
        <div class="box box-solid box-primary">
            ...
            <div class="box-body">
                <table id="contatti_table" class="table table-bordered table-striped" >
                    ...
                    <tr>
                        <th>
                            <button class="btn btn-default btn-sm" type="button" onclick="window.location.href = '{{url('contatti/create/?clifor='.$fornitore->Codice)}}'">
        ...
        <div class="box box-solid box-primary">
            ...
            <div class="box-body">
                <table id="destdiv_table" class="table table-bordered table-striped" >
                    ...
                    <tr>
                        <th>
                            <button class="btn btn-default btn-sm" type="button" onclick="window.location.href = '{{url('destdiv/create')}}'">
                                <span class="glyphicon glyphicon-plus"></span>
                            </button>
                        </th>
                        <th>Indirizzo</th>
