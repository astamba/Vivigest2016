...
@section('content')
    <div class="box box-primary">
        {!! Form::model($pagamento, ['method' => 'DELETE', 'route' => ['pagamenti.destroy', $pagamento->Codice]]) !!}
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    {!! Form::select('Tipologia', array('B'=>'Bonifico',
                                                       ...
                                                       'D'=>'Rimessa Diretta',
                                                       'C'=>'Contrassegno',
                                                       'A'=>'Altro'), null, ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="DataFrom">Prima Scadenza</label>
                    {!! Form::select('DataFrom', array('D'=>'Data Fattura', 'F'=>'Fine Mese'), null, ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="ggPartenza">Prima Rata</label>
                    {!! Form::text('ggPartenza', old('ggPartenza'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="NumScadenze">N° Scadenze</label>
                    {!! Form::number('NumScadenze', old('NumScadenze'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="ggIntervallo">Periodo</label>
                    {!! Form::number('ggIntervallo', old('ggIntervallo'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="PercAcconto">Perc. Acconto</label>
                    {!! Form::number('PercAcconto', old('PercAcconto'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="ggFissi1">gg Fissi 1</label>
                    {!! Form::number('ggFissi1', old('ggFissi1'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="ggFissi2">gg Fissi 2</label>
                    {!! Form::number('ggFissi2', old('ggFissi2'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="ggFissi3">gg Fissi 3</label>
                    {!! Form::number('ggFissi3', old('ggFissi3'), ['class' => 'form-control', 'readonly']) !!}
                </div>
            </div>
        </div>
