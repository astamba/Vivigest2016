...
<head>
    ...
    <title>Vivigest 2016.1 | Log in</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>Vivigest</b> 2016.1</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Loggati per iniziare la tua sessione</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="remember"> Ricorda password
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/register') }}" class="text-center">Registrati</a>
